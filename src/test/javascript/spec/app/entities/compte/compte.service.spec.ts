...
describe('Service Tests', () => {
  describe('Compte Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Compte', async () => {
      ...
      it('should not update a Compte', async () => {
      ...
      it('should not partial update a Compte', async () => {
      ...
      it('should not return a list of Compte', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Compte', async () => {
