...
describe('Service Tests', () => {
  describe('Visite Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Visite(123, 'AAAAAAA', currentDate);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Visite', async () => {
      ...
      it('should not update a Visite', async () => {
      ...
      it('should partial update a Visite', async () => {
      ...
      it('should not partial update a Visite', async () => {
      ...
      it('should not return a list of Visite', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Visite', async () => {
