    ...
    return (
      ...
      (i = [
        ...
        },
        {
          ...
          value: function (e, t) {
            return t.separator
              ? e.replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,').replace(new RegExp(/,/gi, 'gi'), t.separatorsymbol)
        ...
        },
        {
          ...
          value: function (e, t) {
            ...
            return (
              (e = t.currency ? this.convertToCurrencySystem(e, t) : parseFloat(e)), this.applySeparator(e.toLocaleString(void 0, r), t)
            );
          },
        },
        {
