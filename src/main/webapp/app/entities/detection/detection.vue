  ...
  <div>
    <h2 id="page-heading" data-cy="DetectionHeading">
      ...
      <div class="d-flex justify-content-end">
        ...
        <router-link :to="{ name: 'DetectionCreate' }" custom v-slot="{ navigate }">
          <button
            @click="navigate"
            id="jh-create-entity"
          ...
          <tr v-for="detection in detections" :key="detection.id" data-cy="entityTable">
            ...
            <td class="text-right">
              <div class="btn-group">
                ...
                <router-link :to="{ name: 'DetectionEdit', params: { detectionId: detection.id } }" custom v-slot="{ navigate }">
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="pathogeneApp.detection.delete.question" data-cy="detectionDeleteDialogHeading">Confirm delete operation</span></span
      >
