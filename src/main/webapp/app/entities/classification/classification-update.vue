  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2 id="pathogeneApp.classification.home.createOrEditLabel" data-cy="ClassificationCreateUpdateHeading">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" for="classification-code">Code</label>
            <input
              type="text"
              class="form-control"
              name="code"
          ...
          <div class="form-group">
            <label class="form-control-label" for="classification-score">Score</label>
            <input
              type="checkbox"
              class="form-check"
              name="score"
          ...
          <div class="form-group">
            <label class="form-control-label" for="classification-medecin">Medecin</label>
          ...
          <div class="form-group">
            <label class="form-control-label" for="classification-stade">Stade</label>
          ...
          <div class="form-group">
            <label class="form-control-label" for="classification-unclassified">Unclassified</label>
            <select
              class="form-control"
