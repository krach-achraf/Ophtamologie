  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2 id="pathogeneApp.rendezVous.home.createOrEditLabel" data-cy="RendezVousCreateUpdateHeading">Create or edit a RendezVous</h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" for="rendez-vous-date">Date</label>
            <div class="d-flex">
              <input
                id="rendez-vous-date"
                data-cy="date"
          ...
          <div class="form-group">
            <label class="form-control-label" for="rendez-vous-status">Status</label>
            <input
              type="text"
              class="form-control"
              name="status"
          ...
          <div class="form-group">
            <label class="form-control-label" for="rendez-vous-patient">Patient</label>
