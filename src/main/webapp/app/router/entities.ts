...
// prettier-ignore
const RendezVousUpdate = () => import('@/entities/rendez-vous/rendez-vous-update.vue');
// prettier-ignore
const RendezVousDetails = () => import('@/entities/rendez-vous/rendez-vous-details.vue');
// prettier-ignore
...
export default {
  ...
  children: [
    ...
    },
    {
      ...
      component: RendezVousUpdate,
      meta: { authorities: [Authority.USER] },
    },
    {
      path: 'rendez-vous/:rendezVousId/edit',
      name: 'RendezVousEdit',
      component: RendezVousUpdate,
      meta: { authorities: [Authority.USER] },
    },
    {
      path: 'rendez-vous/:rendezVousId/view',
      name: 'RendezVousView',
