...
public class UnclassifiedResource {
    ...
    public ResponseEntity<Unclassified> createUnclassified(@Valid @RequestBody Unclassified unclassified) throws URISyntaxException {
        ...
        unclassified.setCode("UNC-" + unclassified.hashCode());
    ...
    public ResponseEntity<Unclassified> updateUnclassified(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, unclassified.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Unclassified> partialUpdateUnclassified(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, unclassified.getId().toString())
        );
    }
    ...
    public List<Unclassified> getAllUnclassifieds() {
        log.debug("REST request to get all Unclassifieds");
        return unclassifiedRepository.findAll();
    }
