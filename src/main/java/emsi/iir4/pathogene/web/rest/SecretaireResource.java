...
public class SecretaireResource {
    ...
    public ResponseEntity<Secretaire> updateSecretaire(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, secretaire.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Secretaire> partialUpdateSecretaire(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, secretaire.getId().toString())
        );
    }
